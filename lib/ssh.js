...
# Three access tiers for DPanel-managed users.
#
#   dpanel-sftp   — SSH-first default: chrooted SFTP, KEY-only.
#   dpanel-ftp    — Opt-in legacy: chrooted SFTP, password allowed.
#   dpanel-shell  — Allowed shell access (key-only, no chroot).
#
