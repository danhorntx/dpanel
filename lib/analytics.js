...
// ── Public: getRealtime ───────────────────────────────────────────────────────
// Always uses the DB so bot traffic is never counted.
// The ingester runs every 60s, so look back 3 min to give it two full cycles
// of margin — prevents false zero during brief ingester lag.
